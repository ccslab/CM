 ...
 */
public class CMMqttEventPUBCHK extends CMMqttEventFixedHeader {
	//////////////////////////////////////////////////
	 ...
	 */
	public CMMqttEventPUBCHK()
	{
		// initialize CM event ID
		m_nID = CMMqttEvent.PUBCHK;
		// initialize fixed header
		m_packetType = CMMqttEvent.PUBCHK;
		m_flag = 0;
		// initialize variable header
		m_nPacketID = 0;
	}
	
	public CMMqttEventPUBCHK(ByteBuffer msg)
	{
		this();
		unmarshall(msg);
	}
	...
	public String toString()
	{
		...
		strBufVarHeader.append("CMMqttEventPUBCHK {");
